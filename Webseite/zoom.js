...
var svgPanZoomContainer = (function (t) {
	...
	var n = Element.prototype.matches || Element.prototype.webkitMatchesSelector || Element.prototype.msMatchesSelector,
		r = Element.prototype.closest
			...
			: function (t, e) {
					for (; t && !n.call(t, e); ) t = t.parentNode instanceof Element ? t.parentNode : null;
					return t;
			  };
	function m(t, e) {
		var n = r(t, "[" + e + "]");
	...
	function o(t, e, n) {
		...
		var r,
			...
			l = y(t),
			c = ((r = e), (o = n.minScale || 1), (a = n.maxScale || 10), r < o ? o : a < r ? a : r);
		if (c !== l) {
			var s = c / l,
				u = t.scrollLeft,
				m = t.scrollTop,
			...
			if ("transform" === n.scalingProperty) {
				var v = getComputedStyle(i),
					...
					h = new S(v.transform);
				((h = h.translate.apply(h, g.map(E))).d = h.a === h.d ? c : h.d * s), (h.a = c), (h = h.translate.apply(h, g)), (i.style.transform = h), i.setAttribute("transform", h); //Wir haben das nicht selbst gemacht
			} else i.style.width = i.style.height = 100 * c + "%";
			t.setAttribute("data-scale", c), (t.scrollLeft = Math.round(u + f * s - f)), (t.scrollTop = Math.round(m + p * s - p));
		}
	}
	function l(t, e, n) {
		o(t, y(t) * e, n);
			...
			if (leertaste) {
				if (0 === t.button || 2 === t.button) {
					var e = m(t.target, d),
						n = e[0],
						r = e[1];
					if (n && r && ((o = r), (a = f), t.button === ("right" === (o.button || a.button) ? 2 : 0))) {
						var o, a;
						t.preventDefault();
						var i = t.clientX,
							l = t.clientY,
							c = function (t) {
								u(n, i - t.clientX, l - t.clientY), (i = t.clientX), (l = t.clientY), t.preventDefault();
							},
							s = function () {
								removeEventListener("mouseup", s), removeEventListener("mousemove", c), removeEventListener("contextmenu", p);
							};
						addEventListener("mouseup", s), addEventListener("mousemove", c), addEventListener("contextmenu", p);
					}
				}
			}
		}),
