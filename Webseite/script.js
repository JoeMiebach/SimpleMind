...
function findScreenCoords(mouseEvent) {
  ...
  if (elemSelected != null) {
    document.getElementById("selectionVisualisation").setAttribute("x", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft));
    document.getElementById("selectionVisualisation").setAttribute("y", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop));

    document.getElementById("selectionVisualisation").setAttribute("width", snap(elemSelected.getBoundingClientRect().width));
    document.getElementById("selectionVisualisation").setAttribute("height", snap(elemSelected.getBoundingClientRect().height));

    // DRAG BOX
    document.getElementById("selectionVisualisation").setAttribute("x", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft));
    document.getElementById("selectionVisualisation").setAttribute("y", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop));

    document.getElementById("dragTopLeft").setAttribute("cx", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft));
    document.getElementById("dragTopLeft").setAttribute("cy", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop));

    document.getElementById("dragTopRight").setAttribute("cx", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft + elemSelected.getBoundingClientRect().width));
    document.getElementById("dragTopRight").setAttribute("cy", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop));

    document.getElementById("dragBottomRight").setAttribute("cx", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft + elemSelected.getBoundingClientRect().width));
    document.getElementById("dragBottomRight").setAttribute("cy", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop + elemSelected.getBoundingClientRect().height));

    document.getElementById("dragBottomLeft").setAttribute("cx", snap(elemSelected.getBoundingClientRect().x + document.getElementById("workingArea").scrollLeft));
    document.getElementById("dragBottomLeft").setAttribute("cy", snap(elemSelected.getBoundingClientRect().y + document.getElementById("workingArea").scrollTop + elemSelected.getBoundingClientRect().height));
  ...
  if (dragedTopCenter) {
    elemSelected.setAttribute("height", snap(dragedElem.y - mouse.y + dragedElem.height));
    elemSelected.setAttribute("y", mouse.y);
  }

  if (dragedCenterLeft) {
    elemSelected.setAttribute("width", snap(dragedElem.x - mouse.x + dragedElem.width));
